...
## Shell factory design pattern

The shell rendering layer now uses a Factory pattern to centralize shell-specific behavior selection.
...
classDiagram
    ...
    Alias ..> shellFactory : configured by
    Env ..> shellFactory : configured by
    Path ..> shellFactory : configured by
    CDPath ..> shellFactory : configured by
    Link ..> shellFactory : configured by
    Echo ..> shellFactory : configured by
```
