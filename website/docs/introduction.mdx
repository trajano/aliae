...
classDiagram
    class renderStrategy {
      +renderStrategy() ShellFormatStrategy
    }
    ...
    renderStrategy ..> ShellFormatStrategy : selects
    ShellFormatStrategy <|.. zshRenderStrategy
    ShellFormatStrategy <|.. bashRenderStrategy
    ShellFormatStrategy <|.. pwshRenderStrategy
    ShellFormatStrategy <|.. nuRenderStrategy
    ShellFormatStrategy <|.. fishRenderStrategy
    ShellFormatStrategy <|.. tcshRenderStrategy
    ShellFormatStrategy <|.. xonshRenderStrategy
    ShellFormatStrategy <|.. cmdRenderStrategy
    ShellFormatStrategy <|.. noopRenderStrategy

    Alias ..> ShellFormatStrategy : delegates render
    Env ..> ShellFormatStrategy : delegates render
    Path ..> ShellFormatStrategy : delegates render
    CDPath ..> ShellFormatStrategy : delegates render
    Link ..> ShellFormatStrategy : delegates render
    Echo ..> ShellFormatStrategy : delegates render
```
