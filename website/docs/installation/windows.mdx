...
```powershell
scoop bucket add trajano https://github.com/trajano/aliae
...
### Use this repo as the custom Scoop bucket (fork)

This fork already contains `bucket/aliae.json`, so you can use `trajano/aliae` directly as your custom Scoop bucket.
