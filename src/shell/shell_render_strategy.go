...
// ShellRenderStrategy defines shell-specific rendering behavior for all supported section types.
//
...
// the concrete ShellRenderStrategy for the active shell runtime.
